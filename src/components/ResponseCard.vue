...
export default {
  ...
  methods: {
    onButtonClick(value) {
      ...
      console.log("Session state ", this.$store.state.lex.sessionState);
      console.log("Session state slot ", this.$store.state.lex.sessionState.dialogAction.slotToElicit);
      console.log(`Response from Bot: ${message.text}`);
